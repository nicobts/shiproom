...
1. Require `.council/verdict.json`; validate against `council/verdict.schema.json` and
   report any errors precisely.
2. Copy `dashboard/index.html` into `.council/` (overwrite — the page always loads
